...
function setMinesCouner(option) {
  ...
  var hiddenMines = document.querySelectorAll('.cell-mined_closed');
  var minesHidden = hiddenMines.length;
  ...
  if (option === 'init') {
    var minesHiddenArr = String(minesHidden).split('');
...
function saveGameResult(steps, time) {
  ...
  if (localStorage.getItem('results')) {
    ...
    var _resultsObj2 = JSON.parse(localStorage.results);
    console.log(_resultsObj2);
    _resultsObj2[level] = {
      1: {
        steps: steps,
        time: time
    ...
    localStorage.results = JSON.stringify(_resultsObj2);
  }
}
...
function createHeaderHTML() {
  ...
  var level = new _elem_builder__WEBPACK_IMPORTED_MODULE_0__.ElementBuilder('li', levelsList, 'level', 'level_active');
  ...
  /* Custom settings */
  var customSettingsList = new _elem_builder__WEBPACK_IMPORTED_MODULE_0__.ElementBuilder('ul', wrapperHeader, 'custom-settings', 'hidden');
  ...
  settingsItem = new _elem_builder__WEBPACK_IMPORTED_MODULE_0__.ElementBuilder('li', customSettingsList, 'settings-item');
  settingsItem = settingsItem.createElement();
  label = new _elem_builder__WEBPACK_IMPORTED_MODULE_0__.ElementBuilder('label', settingsItem, 'settings-item__name');
  label = label.createElement();
  label.innerText = 'Height: ';
  label.htmlFor = 'custom-height';
  input = new _elem_builder__WEBPACK_IMPORTED_MODULE_0__.ElementBuilder('input', label, 'settings-item__field');
  input = input.createElement();
  input.setAttribute('type', 'number');
  ...
  function checkCell(cell) {
    ...
    function changeStyleToOpened(item) {
      ...
      if (closedStyle.includes('flaged-right')) {
        ...
        item.classList.replace(closedStyle, _unFlagedClass);
      }
...
function showMessage(option) {
  ...
  /* Results */
  if (option === 'results') {
    var _steps = localStorage.getItem('steps-counter');
    var activeLevel = document.querySelector('.level_active');
    var level = activeLevel.innerText.toLowerCase();
...
function themeToggler() {
  ...
  var SwitherName = document.querySelector('.swither-name');
...
var ___CSS_LOADER_URL_IMPORT_24___ = new URL(/* asset import */ __webpack_require__(/*! ./img/buttons/pressed.svg */ "./minesweeper/src/img/buttons/pressed.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_25___ = new URL(/* asset import */ __webpack_require__(/*! ./img/buttons/closed.svg */ "./minesweeper/src/img/buttons/closed.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_26___ = new URL(/* asset import */ __webpack_require__(/*! ./img/buttons/flag.svg */ "./minesweeper/src/img/buttons/flag.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_27___ = new URL(/* asset import */ __webpack_require__(/*! ./img/buttons/mine_wrong.svg */ "./minesweeper/src/img/buttons/mine_wrong.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_28___ = new URL(/* asset import */ __webpack_require__(/*! ./img/buttons/bombs-number/type1.svg */ "./minesweeper/src/img/buttons/bombs-number/type1.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_29___ = new URL(/* asset import */ __webpack_require__(/*! ./img/buttons/bombs-number/type2.svg */ "./minesweeper/src/img/buttons/bombs-number/type2.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_30___ = new URL(/* asset import */ __webpack_require__(/*! ./img/buttons/bombs-number/type3.svg */ "./minesweeper/src/img/buttons/bombs-number/type3.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_31___ = new URL(/* asset import */ __webpack_require__(/*! ./img/buttons/bombs-number/type4.svg */ "./minesweeper/src/img/buttons/bombs-number/type4.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_32___ = new URL(/* asset import */ __webpack_require__(/*! ./img/buttons/bombs-number/type5.svg */ "./minesweeper/src/img/buttons/bombs-number/type5.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_33___ = new URL(/* asset import */ __webpack_require__(/*! ./img/buttons/bombs-number/type6.svg */ "./minesweeper/src/img/buttons/bombs-number/type6.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_34___ = new URL(/* asset import */ __webpack_require__(/*! ./img/buttons/bombs-number/type7.svg */ "./minesweeper/src/img/buttons/bombs-number/type7.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_35___ = new URL(/* asset import */ __webpack_require__(/*! ./img/buttons/bombs-number/type8.svg */ "./minesweeper/src/img/buttons/bombs-number/type8.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_36___ = new URL(/* asset import */ __webpack_require__(/*! ./img/buttons/mine_red.svg */ "./minesweeper/src/img/buttons/mine_red.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_37___ = new URL(/* asset import */ __webpack_require__(/*! ./img/buttons/mine.svg */ "./minesweeper/src/img/buttons/mine.svg"), __webpack_require__.b);
...
document.addEventListener('click', function (e) {
  ...
  if (e.target.classList.contains('level') && !e.target.classList.contains('level_active')) {
    ...
    var customSettings = document.querySelector('.custom-settings');
  ...
  if (e.target.classList.contains('update-btn')) {
    ...
    var minesValue = Number(mines.value);
    if (!width.value) {
    ...
    var maxMinesAmount = Math.floor(widthValue * heightValue * 0.32);
    ...
    localStor.changeValue('custom-mines', "".concat(mines.value));
    (0,_modules_main__WEBPACK_IMPORTED_MODULE_4__.clearGame)();
    for (var _i2 = 0; _i2 < localStorage.length; _i2 += 1) {
      var _key = localStorage.key(_i2);
      if (_key !== 'custom-mines' && _key !== 'custom-height' && _key !== 'custom-width' && _key !== 'results' && _key !== 'sound' && _key !== 'theme') {
  ...
  if (e.target.classList.contains('smile')) {
    ...
    for (var _i6 = 0, _keys = keys; _i6 < _keys.length; _i6++) {
      var _key2 = _keys[_i6];
      if (_key2 !== 'custom-mines' && _key2 !== 'custom-height' && _key2 !== 'custom-width' && _key2 !== 'results' && _key2 !== 'sound' && _key2 !== 'theme') localStorage.removeItem(_key2);
    }
    (0,_modules_main__WEBPACK_IMPORTED_MODULE_4__.clearGame)();
    (0,_modules_main__WEBPACK_IMPORTED_MODULE_4__.createMainHeaderHTML)();
    (0,_modules_main__WEBPACK_IMPORTED_MODULE_4__.createGameFieldHTML)();
...
/******/ })()
;
//# sourceMappingURL=index.ebdc77050b33089e452d.js.map